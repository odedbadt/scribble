...
exports.app_ignite = app_ignite;
const editing_tool_applier_1 = require("./editing_tool_applier");
...
class MainApp {
    constructor() {
        ...
        this.editor = new editing_tool_applier_1.EditingToolApplier(this);
    }
            ...
            if (file && file.type === 'image/png') {
                ...
                reader.onload = function (e) {
                    ...
                    img.onload = function () {
                        ...
                        (0, editing_tool_applier_1.override_canvas_context)(view_context, art_canvas);
                        (0, editing_tool_applier_1.override_canvas_context)(staging_context, art_canvas);
                    };
