...
export class Editor {
    ...
    tool_to_document() {
        ...
        const document_image_data = this.app.document_context.getImageData(this.tool.bounds.x, this.tool.bounds.y, this.tool.w, this.tool.h);
    ...
    refresh_overlay() {
        ...
        this.app.state.overlay_position = Object.assign({}, this.tool.bounds);
    }
    pointerup(event) {
        this.tool.hover(this.view_coords_to_art_coords({ x: event.offsetX, y: event.offsetY }));
        this.refresh_overlay();
