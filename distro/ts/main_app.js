...
import { WebGLRenderer, Scene, OrthographicCamera, ShaderMaterial, Mesh, PlaneGeometry, Texture, CanvasTexture } from "three";
...
export class MainApp {
    constructor() {
        ...
        this.color_stack = new ColorStack(this, 8, 100, 10000, document.getElementById('color-selector-div-fore'), document.getElementById('color-selector-div-back'), document.getElementsByClassName('color_stack_item'));
    ...
    init_camera() {
        ...
        const w = this.view_canvas.width;
        const h = this.view_canvas.height;
        const camera = new OrthographicCamera(0, // left
        w, // right
        h, // top
        0, // bottom
        0, // near
    ...
    build_scene() {
        ...
        const document_geometry = new PlaneGeometry(this.document_canvas.width, this.document_canvas.height);
        const document_rectangle = new Mesh(document_geometry, document_material);
        ...
        const overlay_geometry = new PlaneGeometry(this.state.overlay_position.w, this.state.overlay_position.h);
        ...
        const overlay_rectangle = new Mesh(overlay_geometry, overlay_material);
